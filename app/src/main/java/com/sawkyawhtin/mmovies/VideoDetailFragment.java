...
public class VideoDetailFragment extends Fragment {
   ...
   public static SimpleExoPlayer player;
    ...
    FloatingActionButton download;     //  ဒါက download
    String link;
    @Override
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
      ...
      mRewardedVideoAd = googleAds.loadRewaredVideoAds(getContext());
       ...
       player = ExoPlayerFactory.newSimpleInstance(getContext(),new DefaultTrackSelector());
        ...
        download = myView.findViewById(R.id.btndownload);      //   download  method
            ...
            public void onClick(View v) {
                ...
                alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        {
                            if(getContext().checkSelfPermission(Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED  //  download permission accept condition
...
downloadFile(link);
    ...
    public void downloadFile(String filelink)
    {
        ...
        //Network Allow
        request.setAllowedNetworkTypes(DownloadManager.Request.NETWORK_WIFI | DownloadManager.Request.NETWORK_MOBILE); //  ask wifi or mobile data
